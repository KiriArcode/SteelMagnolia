    ...
    getCyclePhase() {
      if (!this.profile.lastPeriodStart || !this.profile.cycleDay) {
        return { 
          ...
          emoji: '❓', 
          name: 'Не указано', 
          description: 'Настройте отслеживание менструального цикла для получения персонализированных рекомендаций по тренировкам в зависимости от фазы цикла.',
          recommendation: 'Укажите день цикла в настройках' 
        };
      }
      ...
      if (day >= 1 && day <= 14) {
        return {
          ...
          description: 'Дни 1-14: период после менструации. Уровень эстрогена растёт, энергия и выносливость повышаются. Идеальное время для силовых тренировок и установления новых рекордов.',
        ...
        return {
          ...
          emoji: '🔥',
          name: 'Овуляция',
          description: 'Дни 13-16: пик цикла. Максимальный уровень эстрогена и тестостерона. Пиковая производительность, лучшая координация и сила. Отличное время для интенсивных тренировок и PR.',
        ...
        return {
          ...
          description: 'Дни 17-28: период перед менструацией. Уровень прогестерона высокий, может снижаться энергия. Лучше сосредоточиться на кардио, растяжке и восстановлении. Слушайте своё тело.',
      ...
      return { 
        ...
        emoji: '❓', 
        name: 'Не указано', 
        description: 'Настройте отслеживание менструального цикла для получения персонализированных рекомендаций по тренировкам.',
        recommendation: 'Укажите день цикла' 
      };
    },
